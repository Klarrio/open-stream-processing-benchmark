...
class NonIncrementalWindowAfterParsingStageTest extends FlatSpec with Matchers with BeforeAndAfter {
  val overrides: Map[String, Any] = Map("general.last.stage" -> "6",
  ...
  "window after parsing stage " should " have produce correct output " in {
    ...
    val aggregatedStream = statefulStages.nonIncrementalWindowAfterParsingStage(source1)
