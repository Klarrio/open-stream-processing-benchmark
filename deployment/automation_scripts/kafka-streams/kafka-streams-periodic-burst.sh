...
{
   # Display Help
   echo "Kafka Streams periodic burst workload"
   echo
   echo "Parameters:"
...
export MODE="periodic-burst"; echo "- MODE = $MODE" # To make sure the ndw publisher runs at constant speed
