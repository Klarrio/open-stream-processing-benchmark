...
{
   # Display Help
   echo "Flink job failure workload"
   echo
   echo "Parameters:"
...
export PUBLISHER_COUNT=3; #echo "- PUBLISHER_COUNT = $PUBLISHER_COUNT"
export KAFKA_AUTO_OFFSET_RESET_STRATEGY="latest"; #echo "- KAFKA_AUTO_OFFSET_RESET_STRATEGY = $KAFKA_AUTO_OFFSET_RESET_STRATEGY"
export BUFFER_TIMEOUT="100"; #echo "- BUFFER_TIMEOUT = $BUFFER_TIMEOUT"
