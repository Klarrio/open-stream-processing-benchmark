...
{
   # Display Help
   echo "Spark Streaming periodic burst workload"
   echo
   echo "Parameters:"
...
export MODE="periodic-burst" ; echo "- MODE = $MODE"# To make sure the ndw publisher runs with periodic bursts
export DATA_VOLUME=100; echo "- DATA_VOLUME = $DATA_VOLUME"
