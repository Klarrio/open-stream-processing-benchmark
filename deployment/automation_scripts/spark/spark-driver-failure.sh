...
{
   # Display Help
   echo "Spark Streaming driver failure workload"
   echo
   echo "Parameters:"
...
export MODE="master-failure"; echo "- MODE = $MODE"
...
do
  ...
  export FLOWTOPIC=ndwflow-$TOPICNAME
  export SPEEDTOPIC=ndwspeed-$TOPICNAME
  ...
  dcos marathon app kill spark-submit
